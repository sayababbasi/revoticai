            ...
            >
              <div className="contact__rightside cmn__bg">
                ...
                <div className="contact__item mb-20">
                  ...
                  <a style={{textTransform:"none", textDecoration:"none"}} href="#0">contact@revoticai.com</a>
                </div>
                <div className="contact__item mb-20">
                  <span className="he1">Phone</span>
                  <a href="#0">+(92) 316 0513841</a>
                </div>
                <div className="contact__item">
                  <span className="he1">Address</span>
                  <span className="address">Spring Valley, Banigala, Islamabad</span>
                </div>
              </div>
            </div>
          </div>
